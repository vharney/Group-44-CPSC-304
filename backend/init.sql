...
CREATE TABLE Users (
	...
	FOREIGN KEY(acode) REFERENCES AreaCode(acode) ON DELETE SET NULL ON UPDATE CASCADE
);
...
CREATE TABLE Employees_Hire (
	username varchar(40),
	age int,
	employeeID int int NOT NULL AUTO_INCREMENT,
...
CREATE TABLE Applies (
	...
	FOREIGN KEY(title) REFERENCES Jobs(title) ON DELETE CASCADE;
);
...
INSERT INTO Groups VALUES(40, "About Graphic Design");
INSERT INTO Groups VALUES(50, "HR World");
INSERT INTO Groups VALUES(20, "The Economists");
INSERT INTO Groups VALUES(40, "Pride and Prejudice");
INSERT INTO Groups VALUES(60, "Game Developers");

INSERT INTO Posts_Create VALUES("zoom_official", ":/database/Media/1", "Looking for a Software Engineer", "We are looking for a Software Engineer. Click the link below to apply if you have the required qualifications", "hiring");
INSERT INTO Posts_Create VALUES("geek42", NULL, "My Daily Share", "Very glad to announce that I have jouned Amazon today", "post");
INSERT INTO Posts_Create VALUES("apple_official", NULL, "New Product", "Take a peek at the all new iPhone 42", "announcement");
INSERT INTO Posts_Create VALUES("google_official", NULL, "We are Hiring", "Looking for creative minds to join the company. Apply today by clicking the link below", "hiring");
INSERT INTO Posts_Create VALUES("johndoe", NULL, "Random Thought", "Hi everyone, good morning!", "post");
...
INSERT INTO Post_Type_Constraints VALUES("annoucement", 500);
INSERT INTO Post_Type_Constraints VALUES("news", 500);

INSERT INTO Users VALUES('johndoe', 'johndoe5', '6047551234', '604', 'John Doe');
INSERT INTO Users VALUES('janedone', 'janedoe3', '6042883912', '604', 'Jane Doe');
...
INSERT INTO Users VALUES('zoom_official', 'zoom123', '4166048912', '416', 'Zoom');
...
INSERT INTO Companies VALUES("zoom_official", 1000000);
INSERT INTO Companies VALUES("apple_official", 4000000);
INSERT INTO Companies VALUES("slack_official", 500000);
INSERT INTO Companies VALUES("google_official", 30000000);
INSERT INTO Companies VALUES("amazon_official", 50000000);

INSERT INTO Employees_Hire VALUES("johndoe", 30, ":/databaseCV/1", "Graphic Designer", "zoom_official", "Senior");
INSERT INTO Employees_Hire VALUES("janedone", 23, NULL, "Financial Analysts", "apple_official", "Junior");
INSERT INTO Employees_Hire VALUES("jack123", 25, ":/databaseCV/3", "Corporate Counsel", "slack_official", "Manager"); 
INSERT INTO Employees_Hire VALUES("will_iam", 28, ":/databaseCV/4", "Recruiter", "google_official", "Senior");
INSERT INTO Employees_Hire VALUES("geek42", 40, ":/databaseCV/5", "Software Engineer", "amazon_official", "Junior");
...
INSERT INTO Connections VALUES("geek42", "janedone", "approved");
...
INSERT INTO Recommendations VALUES("zoom_official", "johndoe", "Great employee");
INSERT INTO Recommendations VALUES("apple_official", "janedoe", "Greak work ethic");
INSERT INTO Recommendations VALUES("slack_official", "jack123", "Team player");
INSERT INTO Recommendations VALUES("google_official", "will_iam", "Always on time");
INSERT INTO Recommendations VALUES("amazon_official", "geek42", "A pleasure to have");

INSERT INTO Reviews VALUES("zoom_official", "johndoe", "Good company");
INSERT INTO Reviews VALUES("apple_official", "janedoe", "Amazing work environment!");
INSERT INTO Reviews VALUES("slack_official", "jack123", "High pay, balanced workload");
INSERT INTO Reviews VALUES("google_official", "will_iam", "A place where you can grow");
INSERT INTO Reviews VALUES("amazon_official", "geek42", "Proud to be in this amazing company. Offers very good pay");
