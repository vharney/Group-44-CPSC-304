<?php
    ...
    if (!empty($_POST)) {
        ...
        $query="SELECT * from Connections, Users, Employees_Hire WHERE username_1='$username' AND Users.username=username_2 AND Users.username=Employees_Hire.username AND status='approved'";
