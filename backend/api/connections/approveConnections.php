<?php
    ...
    if (!empty($_POST)) {
        ...
        $query="SELECT * from Connections, Users, Employees_Hire WHERE username_2='$username' AND Users.username=username_1 AND Users.username=Employees_Hire.username AND status='pending'";
