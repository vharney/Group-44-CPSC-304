...
<?php
    ...
    if (!empty($_POST)) {
        ...
        $query="SELECT postID, Users.username, fullname, title, text_content FROM Posts_Create, Users WHERE Posts_Create.username=Users.username AND Users.username='$username' ORDER BY postID DESC";
